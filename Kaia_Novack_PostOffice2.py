...
def main():                                                                                              #creates a main function
    ...
    while True:                                                                                          #creates an infinite loop
        ...
        if len(dimensions) != 5:                                                                         #if the length of dimensions does not equal 5
            print ("Please enter 5 parameters!")                                                         #tell the user to enter 5 parameters
            continue                                                                                     #restarts the while True
        else:                                                                                            #if there are 5 parameters
            try:                                                                                                 #attempts the following code to check for user input
                ...
                formatted_total_cost = ("{:.2f}".format(final_cost).lstrip("0"))                                             #formats the final_cost to remove the leading 0 in front of a decimal point and adds the decimal after the number to make it look like currency
